...
% December 18-Jan 25, 2019. Hales-Raya version
...
%%XX Delete statement about first case and algebraically closed fields?
...
%goal 22 of [2], i.e., $([P,0] \oplus [Q,0]) \oplus [\iota Q,0] =
...
%\oplus Q$. On each of the resulting branches, a dichotomy on $R$, $\iota Q$
%is performed. This time the addable cases were easy, but the
%non-addable case required a third dichotomy on $R,\tau \iota Q$. The
...
%$\tau \iota Q$ cannot be added (lemma $\text{not\_add\_self}$). Instead,
